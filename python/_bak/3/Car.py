...
from panda3d.core import CollisionHandlerQueue, CollisionNode, CollisionRay, CollisionBox, LineSegs, Point3, Vec3, BitMask32
import math
...
class KeyboardController(DirectObject):
    ...
    def __init__(self, base):
        ...
        carCollider.node().addSolid(CollisionBox(Point3(0.0, 0.0, 4.5), 6.0, 3.0, 3.5))
    ...
    def initSensors(self, n, h):
        ...
        for i, sensor in enumerate(sensors):
            ...
            self.collisionHandlers.append(handlerQueue)
    ...
    def checkCollisions(self, task):
        ...
        for queue in self.collisionHandlers:
